    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="<?php echo e(asset('storage/product/' . $product->image)); ?>" alt="..." /></div>
                <div class="col-md-6">
                    ...
                    <div class="fs-5 mb-5">
                        <?php if($product['sale_price'] != 0): ?>
                            ...
                            <span>Rp.<?php echo e(number_format($product->sale_price, 0)); ?></span>
                        <?php else: ?>
                ...
                <?php $__currentLoopData = $related; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="<?php echo e(asset('storage/product/' . $product->image)); ?>" alt="..." />
                            <!-- Product details-->
...
</html><?php /**PATH D:\laragon\www\arkatama-laravel\resources\views/product/show.blade.php ENDPATH**/ ?>
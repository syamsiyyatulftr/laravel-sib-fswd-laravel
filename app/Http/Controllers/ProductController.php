...
class ProductController extends Controller
{
    ...
    {
        $products = Product::with('category')->get(); // pakai with karena kita sekalian mau mengambil kategori sesuai relasi dan ('category') harus sama dengan yang di model bagian public functionnya
    ...
    {
        //ini gunanya jika tabel tidak di isi maka tabel akan menggeluarkan notifikasi bahwa tabel tsb harus diisi
